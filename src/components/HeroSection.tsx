  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 relative z-10 flex flex-col items-center justify-center text-center">
        ...
        <AnimatedSection className="text-white mb-6" animation="slide-up" delay={200}>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 drop-shadow-lg dir-rtl">
            شركة البدر الدولية التجارية
          </h1>
          <p className="text-xl md:text-2xl font-light max-w-2xl mx-auto drop-shadow-md dir-rtl">
